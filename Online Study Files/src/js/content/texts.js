const textObj = {
  ...
  greetings: `
   ...
   <div class="column2">
      ...
      <p><strong>YAS</strong> (Young Academy for Sustainability Research) and <strong>YAC</strong> (Young Academy for Cultures and Societies Research)</p>
   </div>
   <div class="column">
   <img src="src/static/UniFreiburg_logo.png" alt="UniFreiburg_logo" style="width:70%; max-height: 150px; max-width: 150px;">
   <div >
      <img src="src/static/YAS.jpg" alt="Another Image" style="width:100%; max-height: 150px; max-width: 150px; margin-left: -10px;">
      <img src="src/static/YAC.jpg" alt="Another Image" style="width:100%; max-height: 150px; max-width: 150px;">
 ...
 <main class="content-horizontal-center content-vertical-center">
   ...
   <div class="hint-box">
       ...
       <br>
       <section>
           The duration of the study is <b>approximately 22 minutes</b>. Please use a <strong>computer or
...
<main class="content-horizontal-center content-vertical-center">
 ...
 <p>Dear participant,</p>
    <p>Thank you for taking part in a study conducted by the Cognition, Action, and Sustainability Unit of the University of Freiburg! Please read the information below carefully.</p>
    ...
    <p>For participating in this study, you will receive the payment amount listed on Prolific.</p>
...
<ol>
  ...
  <li><strong>Questionnaire</strong> – You will answer questions regarding your impressions of the SRW and its characteristics.</li>
  ...
  <li><strong>Final questions</strong> – Finally, you will complete a set of questions about yourself and your background.</li>
</ol>
...
EvaluateInformation: `
 <header>
     <h2>Your Perception of the Video</h2>
 </header>
 
 <main class="content-horizontal-center content-vertical-center">
     <div class="w-xxl text-justify">
Please rate the exciting and the topic presented in the video on the basis of the given adjectives. To do this, provide your answer by selecting one of the buttons that best represents your opinion ranging from 
<u>does not apply at all</u> to <u>applies completely</u>.
<br>
<br>
        <form id="page-form">
            <!-- Presentation Design Section -->
            I found the <b>design</b> of the video...
            <div class="radio-section">
                <table style="width: 100%; border-spacing: 0; margin-top: 10px;">
                    <tr>
                        ...
                        <td style="text-align:right; vertical-align: middle; padding-left: 10px;">
                            <div style="display: flex; justify-content: space-between; width: 100%; margin-bottom: 5px;">
                                <span style="display:inline-block; width: 150px; text-align:left;">Does not apply at all</span>
                                <span style="display:inline-block; width: 150px; text-align:right;">Applies completely</span>
                            </div>
                            <div class="radio-group" style="display: flex; justify-content: space-between; width: 100%; margin-top: 20px;">
                            </div>
                        </td>
                    </tr>
                    <tr>
                        ...
                        <td style="text-align:right; vertical-align: middle; padding-left: 10px;">
                            <div class="radio-group" style="display: flex; justify-content: space-between; width: 100%; margin-top: 20px;">
                                <input type="radio" name="excitingDesign" value="1" required>
                                <input type="radio" name="excitingDesign" value="2" required>
                                <input type="radio" name="excitingDesign" value="3" required>
                                <input type="radio" name="excitingDesign" value="4" required>
                                <input type="radio" name="excitingDesign" value="5" required>
                                <input type="radio" name="excitingDesign" value="6" required>
                                <input type="radio" name="excitingDesign" value="7" required>
                            </div>
                        </td>
                    </tr>
                    ...
                    <tr>
                        ...
                        <td style="text-align:right; vertical-align: middle; padding-left: 10px;">
                            <div class="radio-group" style="display: flex; justify-content: space-between; width: 100%; margin-top: 20px;">
                                <input type="radio" name="entertainingDesign" value="1" required>
                                <input type="radio" name="entertainingDesign" value="2" required>
                                <input type="radio" name="entertainingDesign" value="3" required>
                                <input type="radio" name="entertainingDesign" value="4" required>
                                <input type="radio" name="entertainingDesign" value="5" required>
                                <input type="radio" name="entertainingDesign" value="6" required>
                                <input type="radio" name="entertainingDesign" value="7" required>
                            </div>
                        </td>
                    </tr>
                    ...
                    <tr>
                        ...
                        <td style="text-align:right; vertical-align: middle; padding-left: 10px;">
                            <div class="radio-group" style="display: flex; justify-content: space-between; width: 100%; margin-top: 20px;">
                                <input type="radio" name="boringDesign" value="1" required>
                                <input type="radio" name="boringDesign" value="2" required>
                                <input type="radio" name="boringDesign" value="3" required>
                                <input type="radio" name="boringDesign" value="4" required>
                                <input type="radio" name="boringDesign" value="5" required>
                                <input type="radio" name="boringDesign" value="6" required>
                                <input type="radio" name="boringDesign" value="7" required>
                            </div>
                        </td>
                    </tr>
                    ...
                    <tr>
                        ...
                        <td style="text-align:right; vertical-align: middle; padding-left: 10px;">
                            <div class="radio-group" style="display: flex; justify-content: space-between; width: 100%; margin-top: 20px;">
                                <input type="radio" name="usefulDesign" value="1" required>
                                <input type="radio" name="usefulDesign" value="2" required>
                                <input type="radio" name="usefulDesign" value="3" required>
                                <input type="radio" name="usefulDesign" value="4" required>
                                <input type="radio" name="usefulDesign" value="5" required>
                                <input type="radio" name="usefulDesign" value="6" required>
                                <input type="radio" name="usefulDesign" value="7" required>
                            </div>
                        </td>
                    </tr>
                    ...
                    <tr>
                        ...
                        <td style="text-align:right; vertical-align: middle; padding-left: 10px;">
                            <div class="radio-group" style="display: flex; justify-content: space-between; width: 100%; margin-top: 20px;">
                                <input type="radio" name="unnecessaryDesign" value="1" required>
                                <input type="radio" name="unnecessaryDesign" value="2" required>
                                <input type="radio" name="unnecessaryDesign" value="3" required>
                                <input type="radio" name="unnecessaryDesign" value="4" required>
                                <input type="radio" name="unnecessaryDesign" value="5" required>
                                <input type="radio" name="unnecessaryDesign" value="6" required>
                                <input type="radio" name="unnecessaryDesign" value="7" required>
                            </div>
                        </td>
                    </tr>
                    ...
                    <tr>
                        ...
                        <td style="text-align:right; vertical-align: middle; padding-left: 10px;">
                            <div class="radio-group" style="display: flex; justify-content: space-between; width: 100%; margin-top: 20px;">
                                <input type="radio" name="unimportantDesign" value="1" required>
                                <input type="radio" name="unimportantDesign" value="2" required>
                                <input type="radio" name="unimportantDesign" value="3" required>
                                <input type="radio" name="unimportantDesign" value="4" required>
                                <input type="radio" name="unimportantDesign" value="5" required>
                                <input type="radio" name="unimportantDesign" value="6" required>
                                <input type="radio" name="unimportantDesign" value="7" required>
                            </div>
                        </td>
                    </tr>
                </table>
            ...
            <br>
            <!-- Topic Section -->
            I found the <b>topic</b> presented in the video...
            <div class="radio-section">
                <table style="width: 100%; border-spacing: 0; margin-top: 10px;">
                    <tr>
                        <td style="text-align:left; vertical-align: middle; padding-right: 10px;">
                    ...
                    <tr>
                        ...
                        <td style="text-align:right; vertical-align: middle; padding-left: 10px;">
                            <div class="radio-group" style="display: flex; justify-content: space-between; width: 100%; margin-top: 20px;">
                                <input type="radio" name="excitingTopic" value="1" required>
                                <input type="radio" name="excitingTopic" value="2" required>
                                <input type="radio" name="excitingTopic" value="3" required>
                                <input type="radio" name="excitingTopic" value="4" required>
                                <input type="radio" name="excitingTopic" value="5" required>
                                <input type="radio" name="excitingTopic" value="6" required>
                                <input type="radio" name="excitingTopic" value="7" required>
                            </div>
                        </td>
                    </tr>
                    ...
                    <tr>
                        ...
                        <td style="text-align:right; vertical-align: middle; padding-left: 10px;">
                            <div class="radio-group" style="display: flex; justify-content: space-between; width: 100%; margin-top: 20px;">
                                <input type="radio" name="entertainingTopic" value="1" required>
                                <input type="radio" name="entertainingTopic" value="2" required>
                                <input type="radio" name="entertainingTopic" value="3" required>
                                <input type="radio" name="entertainingTopic" value="4" required>
                                <input type="radio" name="entertainingTopic" value="5" required>
                                <input type="radio" name="entertainingTopic" value="6" required>
                                <input type="radio" name="entertainingTopic" value="7" required>
                            </div>
                        </td>
                    </tr>
                    <tr>
                        ...
                        <td style="text-align:right; vertical-align: middle; padding-left: 10px;">
                            <div class="radio-group" style="display: flex; justify-content: space-between; width: 100%; margin-top: 20px;">
                                <input type="radio" name="boringTopic" value="1" required>
                                <input type="radio" name="boringTopic" value="2" required>
                                <input type="radio" name="boringTopic" value="3" required>
                                <input type="radio" name="boringTopic" value="4" required>
                                <input type="radio" name="boringTopic" value="5" required>
                                <input type="radio" name="boringTopic" value="6" required>
                                <input type="radio" name="boringTopic" value="7" required>
                            </div>
                        </td>
                    </tr>
                    ...
                    <tr>
                        ...
                        <td style="text-align:right; vertical-align: middle; padding-left: 10px;">
                            <div class="radio-group" style="display: flex; justify-content: space-between; width: 100%; margin-top: 20px;">
                                <input type="radio" name="usefulTopic" value="1" required>
                                <input type="radio" name="usefulTopic" value="2" required>
                                <input type="radio" name="usefulTopic" value="3" required>
                                <input type="radio" name="usefulTopic" value="4" required>
                                <input type="radio" name="usefulTopic" value="5" required>
                                <input type="radio" name="usefulTopic" value="6" required>
                                <input type="radio" name="usefulTopic" value="7" required>
                            </div>
                        </td>
                    </tr>
                    ...
                    <tr>
                        ...
                        <td style="text-align:right; vertical-align: middle; padding-left: 10px;">
                            <div class="radio-group" style="display: flex; justify-content: space-between; width: 100%; margin-top: 20px;">
                                <input type="radio" name="unnecessaryTopic" value="1" required>
                                <input type="radio" name="unnecessaryTopic" value="2" required>
                                <input type="radio" name="unnecessaryTopic" value="3" required>
                                <input type="radio" name="unnecessaryTopic" value="4" required>
                                <input type="radio" name="unnecessaryTopic" value="5" required>
                                <input type="radio" name="unnecessaryTopic" value="6" required>
                                <input type="radio" name="unnecessaryTopic" value="7" required>
                            </div>
                        </td>
                    </tr>
                    ...
                    <tr>
                        ...
                        <td style="text-align:right; vertical-align: middle; padding-left: 10px;">
                            <div class="radio-group" style="display: flex; justify-content: space-between; width: 100%; margin-top: 20px;">
                                <input type="radio" name="unimportantTopic" value="1" required>
                                <input type="radio" name="unimportantTopic" value="2" required>
                                <input type="radio" name="unimportantTopic" value="3" required>
                                <input type="radio" name="unimportantTopic" value="4" required>
                                <input type="radio" name="unimportantTopic" value="5" required>
                                <input type="radio" name="unimportantTopic" value="6" required>
                                <input type="radio" name="unimportantTopic" value="7" required>
                            </div>
                        </td>
                    </tr>
                </table>
    ...
    <tr style="height: 80px">
      ...
      <td>
        <select name="sociodemo_education" required class="w-100">
          ...
          <!-- No qualifications -->
          <option value="no_qualification">No qualifications</option>

          <!-- Secondary / GCSEs -->
          <option value="level_1">Level 1 (e.g., GCSEs grades 1‑3 / D‑G or equivalent)</option>
          <option value="level_2">Level 2 (e.g., 5+ GCSEs grades 4+/A*‑C or equivalent)</option>

          <!-- Advanced secondary -->
          <option value="level_3">Level 3 (e.g., A Levels, T Levels, NVQ 3)</option>

          <!-- Higher education -->
          <option value="level_4_5">Level 4‑5 (e.g., HNC, HND, foundation degree)</option>
          <option value="bachelors">Bachelor’s degree or equivalent</option>
          <option value="masters">Master’s degree or postgraduate qualification</option>
          <option value="doctorate">Doctoral degree (PhD) / professional doctorate</option>

          <!-- Other / foreign -->
          <option value="other">Other / foreign qualification</option>
...
<header>
  <h3>
    Please watch the video before clicking “Continue”.
  </h3>
</header>

<main>
  <div class="w-xl text-justify">
Please watch the video about a soft robotic walking system inspired by <span id="manipulation1_text" style="font-weight:bold;">XXX</span>:
  </div>
<div class="w-xl" style="text-align:left; margin-top:20px; font-size:24px;">
  For optimal viewing, use the following controls: on Windows, hold <kbd style="font-size: 18px;">Ctrl</kbd> and scroll, or press <kbd style="font-size: 18px;">+</kbd> / <kbd style="font-size: 18px;">-</kbd>; on Mac, hold <kbd style="font-size: 18px;">Command</kbd> and scroll, or press <kbd style="font-size: 18px;">+</kbd> / <kbd style="font-size: 18px;">-</kbd>.
</div>
  ...
  <div class="w-xl" style="text-align:left; margin-top:20px; font-size: 24px;">
Note: The “Continue” button unlocks after the full video has been watched. Your viewing time is recorded. Watched: <span id="watched-time">0</span> / <span id="video-duration">428</span> seconds.
  </div>
</main>
...
<footer class="content-vertical-center content-horizontal-right">
  <div class="w-l text-justify">
    The “Continue” Button will be enabled after you have finished watching the video.
  </div>
  &nbsp; 
  <button id="continue" type="submit" form="page-form" disabled>
    Continue →
  </button>
</footer>
   `,

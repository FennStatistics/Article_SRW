---
title: "Data analysis - Soft Robot Walker Study"
author: "Julius Fenn"
format:
  html:
    toc: true
...
plot(dat[dat$framingCondition == "bio-inspired", "mean_Ecological"], dat[dat$framingCondition == "bio-inspired", "mean_Bioinspiration_PN"])
...
# create barplot
plot_sdg(hits_ecological)

# create barplot with facets
plot_sdg(hits_ecological) + ggplot2::facet_wrap(~system)
```
```{r}
# run sdg detection
...
# create barplot
plot_sdg(hits_social)

# create barplot with facets
plot_sdg(hits_social) + ggplot2::facet_wrap(~system)
```
...
# create barplot
plot_sdg(hits_economic)

# create barplot with facets
plot_sdg(hits_economic) + ggplot2::facet_wrap(~system)
```
